...
WHERE quality_profile_name = '2160p Efficient FR'
  AND custom_format_name IN (
    ...
    'AAC', 'AMZN', 'ATVP', 'AV1', 'Amazon Enhancement',
    'Audio Description', 'B&W', 'BCORE', 'Better Theatricals',
    'CRAV', 'CRIT', 'DRPO', 'DSNP', 'DTS', 'DTS-ES', 'DTS-HD HRA',
    ...
    'HBO Max Enhancement', 'HDR', 'HDR10+', 'HMAX', 'HTSR', 'HULU',
    'Lossless Audio', 'MA', 'MAX', 'MUBI', 'Movies Anywhere Enhancement',
    'NF', 'NOW', 'Opus', 'PCOK', 'PLAY', 'PMTP', 'ROKU', 'Remux',
...
VALUES
  ...
  ('2160p Compact FR', '1080p WEB-DL (Efficient)', 'radarr', 860000),
  ('2160p Compact FR', '1080p WEB-DL (Efficient)', 'sonarr', 860000),
  ...
  ('2160p Compact FR', 'FR Scene Groups', 'all', 8000),
